...
public class NewGroupActivity extends BaseActivity {
    ...
    private static final int REQUESTCODE_PIC_MEMBER = 3;
    @Bind(R.id.img_back)
    ImageView imgBack;
    @Bind(R.id.txt_title)
    TextView txtTitle;
    ...
    public void save() {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            startActivityForResult(new Intent(this, GroupPickContactsActivity.class).putExtra("groupName", name), REQUESTCODE_PIC_MEMBER);
        }
    }
    ...
    @OnClick({R.id.img_back, R.id.txt_right, R.id.layout_group, R.id.cb_public, R.id.cb_member_inviter})
